    ...
    <div className=" navbar pt-4  items-start rounded-xl ">
      <div className="navbar-start mb-10">
        <div className="dropdown">
          ...
          <a>Manage my posts</a>
          <ul className="p-2 ">
          <li><NavLink to={'/myVolunteerNeedPosts'}>My volunteer need posts</NavLink></li>
          <li><NavLink to={'/myVolunteerRequestPost'}>My Volunteer Request Post</NavLink></li>
          </ul>
        </li>
          </ul>
        </div>
        ...
        {user ? (
          <div className="flex items-center gap-4 relative">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content menu text-xl font-medium  space-y-4 py-4 mt-2 rounded-box bg-zinc-200 z-20  w-60 p-2 shadow"
              >
