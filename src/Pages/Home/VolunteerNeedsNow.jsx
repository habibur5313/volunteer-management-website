...
const VolunteerNeedsNow = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7 sm:gap-4 mt-10">
        {posts.map((post) => (
      ...
      <div className="flex justify-center mt-10">
        <Link to={"/allVolunteer"}>
          {" "}
          <button className="text-xl font-medium btn btn-accent text-white shadow-2xl">
            See all
          </button>
        </Link>
      </div>
